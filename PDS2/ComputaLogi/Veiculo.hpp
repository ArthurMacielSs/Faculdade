...
public:
    ...
    virtual void print_info(); //— imprime o prefixo comum (nesta ordem):
   // Tipo: <tipo>, Placa: <placa>, Ano: <ano>, Capacidade: <capacidade>,
    ...
    virtual double custo_viagem(double km, double carga_kg) =0;// — calcula o custo de uma viagem conforme a derivada.
